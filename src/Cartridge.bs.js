...
function make_mbc3(rom, header) {
  var rom_bank = /* record */[/* contents */1];
  var ram_bank = /* record */[/* contents */0];
  var ram = Caml_array.caml_make_vect(Caml_primitive.caml_int_max(header[/* ram_size */2], 2048), 0);
  var load = function (address) {
    if (in_range(0, 16383, address)) {
      return Caml_array.caml_array_get(rom, address);
    } else if (in_range(16384, 32767, address)) {
      ...
      return Caml_array.caml_array_get(ram, ((ram_bank[0] << 13) + address | 0) - 40960 | 0);
    } else {
      return Pervasives.failwith(Curry._1(Printf.sprintf(/* Format */[
                          /* String_literal */Block.__(11, [
                              "Unhandled rom read $",
  ...
  var store = function (address, value) {
    if (in_range(0, 8191, address)) {
      ...
      var value$1 = value & 127;
      var match = value$1 === 0;
      rom_bank[0] = match ? 1 : value$1;
      return /* () */0;
    } else if (in_range(16384, 24575, address)) {
      if (value >= 0 && value <= 0) {
        ram_bank[0] = value & 3;
      ...
      return Caml_array.caml_array_set(ram, ((ram_bank[0] << 13) + address | 0) - 40960 | 0, value);
    } else {
      return Pervasives.failwith(Curry._2(Printf.sprintf(/* Format */[
                          /* String_literal */Block.__(11, [
                              "Unhandled rom write $",
