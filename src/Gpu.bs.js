...
function render_background(gpu, io_regs) {
  ...
  var match = (gpu[/* control */2] & 16) > 0;
  var tile_data = match ? 32768 : 36864;
  var match$1 = (gpu[/* control */2] & 8) > 0;
...
function render_window(gpu, io_regs) {
  var palette = Caml_array.caml_array_get(io_regs, 71);
  var colors = /* array */[
    palette & 3,
    (palette >>> 2) & 3,
  ...
  var match = (gpu[/* control */2] & 16) > 0;
  var tile_data = match ? 32768 : 36864;
  var match$1 = (gpu[/* control */2] & 64) > 0;
  var tile_map = match$1 ? 39936 : 38912;
  var window_y = ly - gpu[/* window_y */13] | 0;
  var y = window_y / 8 | 0;
  var y_offset = window_y % 8;
  var window_x = gpu[/* window_x */12] - 7 | 0;
  for(var px = 0; px <= 159; ++px){
    if (px >= window_x) {
      var x = (px - window_x | 0) / 8 | 0;
      var tile = load(gpu, (tile_map + (y << 5) | 0) + (x & 65535) | 0);
      var ptr = tile_data !== 36864 ? tile_data + (tile << 4) & 65535 : tile_data + (Utils$Yobml.signed(tile) << 4) & 65535;
      var ptr$1 = ptr + (y_offset << 1) & 65535;
      var p0 = load(gpu, ptr$1);
      var p1 = load(gpu, ptr$1 + 1 | 0);
      var colb = 7 - px % 8 | 0;
      var match$2 = Utils$Yobml.is_bit_set(p0, colb);
      var pix0 = match$2 ? 1 : 0;
      var match$3 = Utils$Yobml.is_bit_set(p1, colb);
      var pix1 = match$3 ? 2 : 0;
      var coln = pix0 | pix1;
      var color = Caml_array.caml_array_get(colors, coln);
      set_pixel(gpu, px, ly, color);
    }
  ...
  switch (mode) {
    case 0 : 
        return /* record */[
                ...
                /* window_x */gpu[/* window_x */12],
                /* window_y */gpu[/* window_y */13],
                /* interrupts */gpu[/* interrupts */14],
                /* new_frame */gpu[/* new_frame */15]
              ];
    case 1 : 
        return /* record */[
                /* mode : HBlank */1,
...
function step(gpu, cycles, lcd_on, io_regs) {
  ...
  switch (match) {
    case 0 : 
        if (cycles$1 >= 456) {
          ...
          gpu$2 = ly >= 154 ? set_mode(/* record */[
                  ...
                  /* window_x */gpu$1[/* window_x */12],
                  /* window_y */gpu$1[/* window_y */13],
                  /* interrupts */gpu$1[/* interrupts */14],
                  /* new_frame */gpu$1[/* new_frame */15]
                ], /* OamRead */2) : /* record */[
              /* mode */gpu$1[/* mode */0],
              /* lcd */gpu$1[/* lcd */1],
              /* control */gpu$1[/* control */2],
    ...
    case 3 : 
        if (cycles$1 >= 172) {
          ...
          if (lcd_on) {
            if (!Utils$Yobml.is_bit_set(gpu$1[/* control */2], 0)) {
              $$Array.fill(gpu$1[/* frame */6], 0, 23040, 0);
            }
            render_window(gpu$1, io_regs);
  ...
  if (gpu$2[/* ly */3] === gpu$2[/* lyc */4]) {
    return /* record */[
            ...
            /* window_x */gpu$2[/* window_x */12],
            /* window_y */gpu$2[/* window_y */13],
            /* interrupts */gpu$2[/* interrupts */14] | 2,
            /* new_frame */gpu$2[/* new_frame */15]
          ];
  } else {
    return /* record */[
            /* mode */gpu$2[/* mode */0],
            ...
            /* window_x */gpu$2[/* window_x */12],
            /* window_y */gpu$2[/* window_y */13],
            /* interrupts */gpu$2[/* interrupts */14],
            /* new_frame */gpu$2[/* new_frame */15]
          ];
  }
}
...
exports.render_window = render_window;
